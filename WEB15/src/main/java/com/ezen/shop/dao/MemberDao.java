...
import com.ezen.shop.dto.LAddressVO;
import com.ezen.shop.dto.LMemberVo;
...
public class MemberDao {
	...
	public LMemberVo getMember(String id) {
		LMemberVo mvo = null;
	...
	public ArrayList<LAddressVO> selectAddress(String dong) {
		
		ArrayList<LAddressVO> list = new ArrayList<LAddressVO>();
		con = Dbman.getConnection();
		String sql = "select * from Laddress where dong like '%'||?||'%' ";
	...
	public int insertMember(LMemberVo mvo) {
